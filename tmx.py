...
# This code is placed in the Public Domain. (you cant copyright and then place in public domain! It\'s meaningless!)
#your mom is public domain
# GUESS who's gonna change it for their profit?
# 
...
visible: Whether the object is shown (1) or hidden (0). Defaults to 1.
        ...
        def __init__(self, type, x, y, width=0, height=0, name=None,
                ...
                try:
                        ...
                        print('Error giving object a rect')
...
##                                print(i,'i')
                        ...
                        try:
                                ...
                                #quick and dirty, like my usual programming
                                value = '1'
                                print('value error, set to 1')
                        ...
                        for i in game.items:
                                if i.name == self.name:
                                        ...
                                        if game.currentplace == 'place_of_judgement.tmx':
                                                if self.name == 'sword':
                                                        i.specialproperties['rejection'] = False
...
class ObjectLayer(object):
        ...
        #And I'm not gonna bother digging this up to see why.
        #Guess that makes me an experienced programmer.
##                '''Draw this layer, limited to the current viewport, to the Surface.
##                '''
##                if not self.visible:
##                        return
...
##
        ...
        def get_at(self, x, y):
                ...
                '''
                for leon in self.objects:
                        if [leon.left, leon.top] == [x*32,y*32]:
                                return leon 
...
class SpriteLayer(pygame.sprite.AbstractGroup):
        ...
        def draw(self, screen):
                ...
                #print(self,ox,oy)
                w, h = self.view_w, self.view_h
##                sortsprites = copy.copy(self.sprites())
##                print(sortsprites,'sortsprites')
##                sortedsprites = []
##                for i in sortsprites:
##                        sortedsprites.append(i.rect.bottom)
##                print(sortedsprites, 'unsorted')
##                sortedsprites.sort()
##                print(sortedsprites,'sorted')
##                spriteorder = []
##                while len(sortedsprites) != 0:
##                        for i in self.sprites
##                                for x in sortedsprites:
##                                        if i.rect.bottomy == x:
##                                                n
